var fs, dirname, path, exec, spawn, subproc, exists, Seq, glob, yaml, mkdirp, express, op, readFilesAsync, Controller, view_helpers, BASE, LIB, SRC, STATIC, WWW, NODE_ENV, IS_DEV, IS_PROD, LOG_LEVEL, REV, DEFAULT_OPTIONS, exports, application, _ref, _;
fs = require('fs');
  ...
  init: function(opts){
    ...
    this.configure('development', function(){
      ...
      this.use(require('browserify')({
        ...
        require: ['operator', 'underscore', 'underscore.nested', 'underscore.kv', 'seq', 'd3', 'events'],
